    ...
    <div name='contact' className='w-full h-screen
        ...
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            <div className='pb-8'>
                ...
                <p className='py-6'>Submit the form to keep in touch with me</p>
            </div>

            <div className='flex  justify-center items-center'>
                <form action="https://getform.io/f/119c26c9-8a84-452c-a873-8eb2c3d90fa3" method='POST' className='flex flex-col w-full md:w-1/2'>
                    <input type="text"
                        name='name'
                    ...
                    <button className='text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-6 py-3 my-8 mx-auto
                       items-center rounded-md hover:scale-110 duration-300'>Lets's Talk</button>
                </form>
            </div>
        </div>
    </div>
